...
#define STRING_CONFIG_H_AUTHOR "(Javmarina, Anet A8 config)" // Who made the changes.
...
#define EXTRUDE_MINTEMP 190  // 160 guards against false tripping when the extruder fan kicks on. Won't extrude if below 190
